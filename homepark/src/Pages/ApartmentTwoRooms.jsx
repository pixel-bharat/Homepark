      ...
      <header className="page-header" data-background="images/slide01.jpg" data-stellar-background-ratio="1.15">
        <div className="container">
          ...
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active" aria-current="page">Two Rooms</li>
          </ol>
        </div>
        {/* end container */}
      </header>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2><span>Two Rooms</span> 65m² Homepark Flat</h2>
              <h5>By aiming to take the life quality to an upper level with the whole realized Projects of luxury.</h5>
              <div className="property-infos">
                <span className="odometer" data-count="42700" data-status="yes" data-text="$">0</span>
                <p>Price of property</p>
                <span className="odometer" data-count="65" data-status="yes" data-text="m²">0</span>
                <p>Size of apartment</p>
                <span className="odometer" data-count="24" data-status="yes" data-text="%">0</span>
...
export default ApartmentTwoRooms;
